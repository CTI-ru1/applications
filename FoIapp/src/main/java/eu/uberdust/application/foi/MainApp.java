...
public class MainApp {
    ...
    public static final String CAPABILITY_LIGHT = "urn:node:capability:light";
    public static final String CAPABILITY_PIR = "urn:node:capability:pir";
    public static final String CAPABILITY_SCREENLOCK = "urn:node:capability:lockScreen";
    ...
    public static void main(final String[] args) {
        ...
        if("ichatzWorkstation".equals(MODE) || "Workstation".equals(MODE)){
